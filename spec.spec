...
a.datas += [('folder_y.png',cwd+'\\res\\folder_y.png', 'DATA'),
	    ...
	    ('Huawei.txt',cwd+'\\res\\config\\Huawei.txt', 'DATA'),
	    ('iOS Photos.txt',cwd+'\\res\\config\\iOS Photos.txt', 'DATA'),
	    ('iOS Snapshots.txt',cwd+'\\res\\config\\iOS Snapshots.txt', 'DATA'),
	    ('Samsung.txt',cwd+'\\res\\config\\Samsung.txt', 'DATA'),		
	    ('Sony.txt',cwd+'\\res\\config\\Sony.txt', 'DATA')
            ]
